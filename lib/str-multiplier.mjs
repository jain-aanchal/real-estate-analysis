...
const VACATION_CITIES = new Set([
  ...
  'oakhurst', 'mariposa', 'groveland', 'el portal', 'elportal', 'wawona',
  'fish camp', 'fishcamp', 'bass lake', 'basslake', 'coarsegold',  // Yosemite
  'three rivers', 'threerivers', 'kings canyon',                    // Sequoia / Kings Canyon
  'lone pine', 'lonepine', 'bishop',                                // Eastern Sierra
  'mount shasta', 'mtshasta', 'shasta lake', 'mccloud',             // Mt Shasta
  'tusayan', 'williams', 'grand canyon', 'grandcanyon',             // Grand Canyon
  'springdale', 'la verkin', 'laverkin', 'hurricane',               // Zion
  'bryce', 'bryce canyon', 'brycecanyon', 'tropic',                 // Bryce Canyon
  'moab', 'castle valley', 'castlevalley',                          // Arches / Canyonlands
  'estes park', 'estespark', 'grand lake', 'grandlake',             // Rocky Mountain
  'joshua tree', 'joshuatree', 'twentynine palms', 'yucca valley',  // Joshua Tree
  'west yellowstone', 'westyellowstone', 'gardiner', 'cody',        // Yellowstone
  'west glacier', 'westglacier', 'east glacier',                    // Glacier
  'bar harbor', 'barharbor', 'southwest harbor',                    // Acadia
  'townsend',                                                       // Smoky Mountains gateway
  'crater lake', 'craterlake',                                      // Crater Lake
  // Wine country / NorCal vacation
  'napa', 'st helena', 'sthelena', 'calistoga', 'sonoma', 'healdsburg',
  'sebastopol', 'guerneville', 'glen ellen', 'glenellen', 'yountville',
  // CA central / north coast vacation
  'trinidad', 'arcata', 'samoa', 'ferndale', 'gualala',
  // Cape Cod / Islands
  'cape cod', 'capecod', 'provincetown', 'hyannis', 'falmouth', 'chatham',
  'orleans', 'truro', 'wellfleet', 'eastham', 'brewster', 'dennis',
  'marthas vineyard', 'oak bluffs', 'edgartown', 'tisbury',
  'nantucket', 'siasconset',
  // Misc famous vacation
  'gatlinburg', 'pigeon forge', 'sevierville',  // (already listed in SE block above; dups ok)
  'mackinac island', 'mackinacisland', 'mackinaw city',
  'door county', 'doorcounty', 'sister bay', 'sturgeon bay', 'fish creek',
  'galena',                                                         // IL river-town vacation
  'hot springs', 'hotsprings',                                      // AR
  'eureka springs', 'eurekasprings',                                // AR
  'branson',                                                        // MO
  'lake of the ozarks', 'lakeoftheozarks', 'osage beach',
  'beaver creek',                                                   // (already listed)
  // Ski / mountain
